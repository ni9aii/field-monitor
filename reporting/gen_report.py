...
Usage:
  python3 gen_report.py \
    ...
    --empty-reason "watchdog перезагрузки коллектора collector-host 22.07 вечером" \
...
SERVERS = {
    "vp-ruvds-1":       ("Владивосток", "RUVDS", "[REDACTED]"),
    "EKB":               ("Екатеринбург", "отдельный ДЦ", "[REDACTED]"),
    "vp-ruvds-4":       ("Екатеринбург", "RUVDS", "[REDACTED]"),
    "vp-ruvds-3":       ("Казань", "RUVDS", "[REDACTED]"),
    "vp-mow-vladimir":      ("Москва", "отдельный ДЦ", "[REDACTED]"),
    "bm-server": ("Москва", "отдельный ДЦ", "[REDACTED]"),
    "vp-ruvds-5":       ("Санкт-Петербург", "RUVDS", "[REDACTED]"),
    "omsk.org":          ("Омск", "отдельный ДЦ", "[REDACTED]"),
    "vp-perm-home":         ("Пермь", "отдельный ДЦ", "[REDACTED]"),
    "SPB":               ("Санкт-Петербург", "отдельный ДЦ", "[REDACTED]"),
    "vp-spb2-relay":  ("Санкт-Петербург", "тот же ДЦ, что SPB (relay)", "[REDACTED]"),
    "vp-ruvds-2":       ("Новосибирск", "RUVDS", "[REDACTED]"),
}
